...
import com.caidong.wechat.application.WeChatApp;
import com.caidong.wechat.enums.TranslationState;
import com.caidong.wechat.util.interfaces.OnItemClickPopupMenuListener;
import com.caidong.wechat.util.interfaces.OnStartSwipeRefreshListener;
...
public class Utils {
    ...
    public static int dp2px(float dpValue) {
        return (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, dpValue, WeChatApp.sContext.getResources().getDisplayMetrics());
    }

    public static int getScreenWidth() {
        return WeChatApp.sContext.getResources().getDisplayMetrics().widthPixels;
    }

    public static int getScreenHeight(){
        return WeChatApp.sContext.getResources().getDisplayMetrics().heightPixels;
    }
